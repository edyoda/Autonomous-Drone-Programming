...
8. Save the script by pressing Ctrl+S,Ctrl+X and ENTER.
...
12. To retrieve simulation software binary session, do the below.

`screen -r vehicle`

13. To exit the simulation software binary session, press Ctrl+a, d and ENTER.

14. To retrieve MAVProxy session, do the below.

`screen -r proxy`

15. To exit the MAVProxy session, press Ctrl+a, d and ENTER.

16. To stop the simulation software binary session, do the below.

`screen -S vehicle -X quit`

17. To stop the MAVProxy session, do the below.

`screen -S proxy -X quit`

18. To stop both of them at the same time, do the below.
